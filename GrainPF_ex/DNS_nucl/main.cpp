...
int main(int argc, char** argv)
{
    ...
    std::string out_direc = "AM_deep";//argv[2];
...
//    std::cout<<std::endl;
   ...
   */
    ...
    string out_format = "Phi_split_randDNS_NBW1_nx"+to_string(params.nx)+"_ny"+to_string(params.ny)+"_Mt"+to_string(params.Mt)+"_seed"+to_string(params.seed_val) + "_delta"+to_string(params.delta)+ "_grains"+ to_string((int)num_theta);
