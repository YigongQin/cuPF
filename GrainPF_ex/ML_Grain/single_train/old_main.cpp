...
//    params.ny = (int) (params.asp_ratio*params.nx);
    params.lxd = 10; //-params.xmin; //this has assumption of [,0] params.dx*params.W0*params.nx; # horizontal length in micron
...
//    std::cout<<std::endl;
   ...
   */
    ...
    for(int id=0; id<length; id++){
     ...
     //   Uc[id]=0.0;
      ...
      // directly give the phase id, 0 reserved for liquid
 ...
 string out_format = "ML_Mt"+to_string(params.Mt)+"_seed"+to_string(atoi(argv[3]));
