...
//    MPI_Comm_size(comm, &pM.nproc);
  ...
  //  std::string mac_folder = "./Takaki/";
   ...
   // read_input(mac_folder+"/alpha.txt",mac.alpha_mac);
    ...
    float top;
    read_input(mac_folder+"/top.txt", &top);
    //G0 = atof(argv[4]);
    //Rmax = atof(argv[5]); 
...
//    params.lyd = params.asp_ratio*params.lxd;
    ...
    params.ini_h = (int) (2/params.dx/params.W0);
    float dh = top/params.nts;
    params.delta_h = (int) (dh/params.dx/params.W0);
  //  int kts = params.Mt/params.nts;
   ...
   // std::cout<<"Dl = "<<params.Dl<<std::endl;
    ...
    std::cout<<"height increment = "<<dh<<std::endl;
